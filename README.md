...
This project started as a personal journey to dive deep into C++ and game state management. What began as a simple grid has evolved into a fully functional chess board with time-traveling mechanics and PGN generation!
